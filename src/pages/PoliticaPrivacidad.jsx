    ...
    <main className="min-h-screen bg-white/90">
      <section className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="bg-primary/10 rounded-xl p-6 text-gray-800 text-sm">
          <p className="mb-4">Tu privacidad es importante para nosotros. En BDR Gestión Inmobiliaria SpA, nos comprometemos a proteger tus datos personales y a usarlos únicamente para los fines necesarios.</p>
          ...
          <p className="mb-4">Puedes solicitar la modificación o eliminación de tus datos en cualquier momento. Para ello, contáctanos a <a href="mailto:gonzalo.rojas@bienderaiz.cl" className="underline text-primary">gonzalo.rojas@bienderaiz.cl</a>.</p>
